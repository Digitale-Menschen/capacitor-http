...
<p align="center"><strong><code>@digitale-menschen/capacitor-http</code></strong></p>
<p align="center">
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@digitale-menschen/capacitor-http"><img src="https://img.shields.io/npm/l/@digitale-menschen/capacitor-http?style=flat-square" /></a>
<br>
  <a href="https://www.npmjs.com/package/@digitale-menschen/capacitor-http"><img src="https://img.shields.io/npm/dw/@digitale-menschen/capacitor-http?style=flat-square" /></a>
  <a href="https://www.npmjs.com/package/@digitale-menschen/capacitor-http"><img src="https://img.shields.io/npm/v/@digitale-menschen/capacitor-http?style=flat-square" /></a>
...
```bash
npm install @digitale-menschen/capacitor-http
npx cap sync
```
...
```bash
npm install @digitale-menschen/capacitor-http@0.x
```
...
```typescript
import { Http } from '@digitale-menschen/capacitor-http';
